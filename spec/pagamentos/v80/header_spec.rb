...
RSpec.describe Cnab240::V80::Pagamentos::Header do
  ...
  it "deve conter campos header" do
    ...
    expect(header).to respond_to(:identificacao_lancamento)
    ...
    expect(header).to respond_to(:finalidade_lote)
    expect(header).to respond_to(:historico_cc)
