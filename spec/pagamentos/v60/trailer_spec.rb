...
RSpec.describe Cnab240::V60::Pagamentos::Trailer do
  it 'deve conter campos trailer' do
    trailer = Cnab240::V60::Pagamentos::Trailer.new
    ...
    expect(trailer).to respond_to(:totais_moedas)
    expect(trailer).to respond_to(:totais_avisos_debitos)
