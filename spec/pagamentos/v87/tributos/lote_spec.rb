...
describe Cnab240::Lote do
  ...
  it "deve conter trailer e header" do
    ...
    lote.header.should be_an_instance_of(Cnab240::V87::PagamentosTributos::Header)
    lote.trailer.should be_an_instance_of(Cnab240::V87::PagamentosTributos::Trailer)
  end

  it "deve conter segmento o" do
    lote = Cnab240::Lote.new(:operacao => :pagamento_titulo_tributos, :tipo => :remessa, :versao => 'V87')
    lote << :o
    lote.segmentos[0].should be_an_instance_of(Cnab240::V87::SegmentoO)
  end
  ...
  it "pode conter segmento w" do
    lote = Cnab240::Lote.new(:operacao => :pagamento_titulo_tributos, :tipo => :remessa, :versao => 'V87')
    lote << :w
    lote.segmentos[0].should be_an_instance_of(Cnab240::V87::SegmentoW)
  end

  it "pode conter segmento z" do
    lote = Cnab240::Lote.new(:operacao => :pagamento_titulo_tributos, :tipo => :remessa, :versao => 'V87')
    lote << :z
    lote.segmentos[0].should be_an_instance_of(Cnab240::V87::SegmentoZ)
  end
