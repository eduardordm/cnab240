...
RSpec.describe Cnab240::V86::SegmentoN1 do

  it "deve instanciar segmento" do
    segmento = Cnab240::V86::SegmentoN1.new
    expect(segmento).to be_an_instance_of(Cnab240::V86::SegmentoN1)
  end
