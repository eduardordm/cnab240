...
RSpec.describe Cnab240::V86::SegmentoZ do
  it 'deve instanciar segmento' do
    segmento = Cnab240::V86::SegmentoZ.new
    expect(segmento).to be_an_instance_of(Cnab240::V86::SegmentoZ)
  end
