...
RSpec.describe Cnab240::V87::SegmentoN7 do
  it 'deve instanciar segmento' do
    segmento = Cnab240::V87::SegmentoN7.new
    expect(segmento).to be_an_instance_of(Cnab240::V87::SegmentoN7)
  end
