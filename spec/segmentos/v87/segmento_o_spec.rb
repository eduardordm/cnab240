...
RSpec.describe Cnab240::V87::SegmentoO do
  it 'deve instanciar segmento' do
    segmento = Cnab240::V87::SegmentoO.new
    expect(segmento).to be_an_instance_of(Cnab240::V87::SegmentoO)
  end
