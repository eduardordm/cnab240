...
RSpec.describe Cnab240::V81::SegmentoS do
  it 'deve instanciar segmento' do
    segmento = Cnab240::V81::SegmentoS.new
    expect(segmento).to be_an_instance_of(Cnab240::V81::SegmentoS)
  end
  ...
  it 'deve conter campos' do
    ...
    expect(segmento).to respond_to(:tipo_impressao)
    expect(segmento).to respond_to(:informacao_5)
    expect(segmento).to respond_to(:informacao_6)
    expect(segmento).to respond_to(:informacao_7)
    expect(segmento).to respond_to(:informacao_8)

    expect(segmento).to respond_to(:informacao_9)
