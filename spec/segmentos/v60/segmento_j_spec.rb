...
RSpec.describe Cnab240::V60::SegmentoJ do

  it "deve instanciar segmento" do
    segmento = Cnab240::V60::SegmentoJ.new
    expect(segmento).to be_an_instance_of(Cnab240::V60::SegmentoJ)
  end
