...
RSpec.describe TransferenciaCitibank do
  ...
  it "deve criar pagamento" do
    ...
    pagamento = TransferenciaCitibank.new(beneficiario)
    ...
    expect(pagamento.arquivo.header.banco_nome.strip).to eq 'BANCO CITIBANK S/A'
  end
end